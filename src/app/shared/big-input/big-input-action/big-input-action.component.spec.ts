...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<sigma-big-input-action></sigma-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<sigma-big-input-action [disabled]="true"></sigma-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<sigma-big-input-action fontSet="fas" fontIcon="fa-trash"></sigma-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<sigma-big-input-action label="delete"></sigma-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<sigma-big-input-action (action)="actionHandler()"></sigma-big-input-action>';
    fixture = createHostComponent(template);
